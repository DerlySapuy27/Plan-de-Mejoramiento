            ...
            <div class="main-page">
                <div class="container-fluid">
                    <div class="row page-title-div">
                        <div class="col-md-6">
                            <h2 class="title">Actualizar Tecnólogo</h2>
                        </div>
                    ...
                    <div class="row breadcrumb-div">
                        <div class="col-md-6">
                            <ul class="breadcrumb">
                                ...
                                <li><a href="#">Años</a></li>
                                <li class="active">Actualizar Tecnólogo</li>
                            </ul>
                        </div>
                                ...
                                <div class="panel">
                                    <div class="panel-heading">
                                        <div class="panel-title">
                                            <h5>Actualizar Información de Tecnólogo</h5>
                                        </div>
                                    </div>
                                    <?php if ($msg) { ?>
                                    ...
                                    <form method="post">
                                        ...
                                        if ($query->rowCount() > 0) {
                                            foreach ($results as $result) {   ?>
                                                ...
                                                <div class="form-group has-success">
                                                    <label for="success" class="control-label">Número  de Trimestres</label>
                                                    <div class="">
                                                        ...
                                                        <span class="help-block">Ejemplo - 1,2,4,5 </span>
                                                    </div>
                                                </div>
                                                <div class="form-group has-success">
                                                    <label for="success" class="control-label">Ficha Tecnólogo</label>
                                                    <div class="">
                                                        <input type="text" name="section" value="<?php echo htmlentities($result->Section); ?>" class="form-control" required="required" id="success">
                                                        <span class="help-block">Ejemplo - 2500871 </span>
                                                    </div>
                                                </div>
                                        <?php }
                                        } ?>
