...
<body>
<?php include('includes/nav-result.php'); ?>
            ...
            <div class="content-container">
                ...
                <div class="main-page">
                    <div class="container-fluid">
                        <!-- /.row -->
                        <h1>Tus Resultados Por Materia</h1>
                                    ...
                                    <div class="panel">
                                        <div class="panel-heading">
                                            <div class="panel-title">
                                                ...
                                                <?php
                                                // code Student Data
                                                $rollid = $_POST['documento'];
                                                $classid = $_POST['class'];
                                                $_SESSION['documento'] = $rollid;
                                                $_SESSION['classid'] = $classid;
                                                $qery = "SELECT   tblstudents.StudentName,tblstudents.documento,tblstudents.RegDate,tblstudents.StudentId,tblstudents.Status,tblclasses.ClassName,tblclasses.Section from tblstudents join tblclasses on tblclasses.id=tblstudents.ClassId where tblstudents.documento=:documento and tblstudents.ClassId=:classid ";
                                                $stmt = $dbh->prepare($qery);
                                                $stmt->bindParam(':documento', $rollid, PDO::PARAM_STR);
                                                ...
                                                if ($stmt->rowCount() > 0) {
                                                    foreach ($resultss as $row) {   ?>
                                                        ...
                                                        <p><b> Documento</b> <?php echo htmlentities($row->documento); ?>
                                            ...
                                            <div class="panel-body p-20">
                                                ...
                                                <table class="table table-hover table-bordered" border="1" width="100%">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $query = "select t.StudentName,t.documento,t.ClassId,t.marks,SubjectId,tblsubjects.SubjectName from (select sts.StudentName,sts.documento,sts.ClassId,tr.marks,SubjectId from tblstudents as sts join  tblresult as tr on tr.StudentId=sts.StudentId) as t join tblsubjects on tblsubjects.id=t.SubjectId where (t.documento=:documento and t.ClassId=:classid)";
                                                        $query = $dbh->prepare($query);
                                                        $query->bindParam(':documento', $rollid, PDO::PARAM_STR);
                                                        ...
                                                        <?php
                                                            ...
                                                            <?php
                                                            echo htmlentities("Documento inválido");
                                                        }
                                                            ?>
                                                            </div>
                                                    </tbody>
