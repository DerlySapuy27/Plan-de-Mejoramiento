...
if (strlen($_SESSION['alogin']) == "") {
    ...
    if (isset($_POST['submit'])) {
        ...
        $dob = $_POST['dob'];
        $status = 1;
        $sql = "INSERT INTO  tblstudents(StudentName,documento,StudentEmail,Gender,ClassId,DOB,Status) VALUES(:studentname,:documento,:studentemail,:gender,:classid,:dob,:status)";
                                ...
                                <div class="panel">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form class="row" method="post">
                                            ...
                                            <div class="form-group col-md-6">
                                                <label for="default" class="control-label">Documento</label>
                                                <input type="text" name="documento" class="form-control" id="documento" maxlength="5" required="required" autocomplete="off">
