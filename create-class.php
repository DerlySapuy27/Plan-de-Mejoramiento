                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form method="post">
                                            <div class="form-group has-success">
                                                <label for="success" class="control-label">Nombre Técnologo</label>
                                                <div class="">
                                                    <input type="text" name="classname" class="form-control" required="required" id="success">
                                                    <span class="help-block">Nombre Tecnólogo</span>
                                                </div>
                                            </div>
                                            <div class="form-group has-success">
                                            ...
                                            <div class="form-group has-success">
                                                <label for="success" class="control-label">Ficha</label>
                                                <div class="">
                                                    <input type="text" name="section" class="form-control" required="required" id="success">
                                                    <span class="help-block">Número de Ficha</span>
                                                </div>
                                            </div>
                                            <div class="form-group has-success">
