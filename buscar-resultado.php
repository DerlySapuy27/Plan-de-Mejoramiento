...
<body class="" style="background-image: url(assets/images/back11.jpg);
                    ...
                    <div class="panel login-box" style="    background: #3d86ed;">
                        <div class="panel-heading">
                            <div class="panel-title text-center">
                                <a href="#">
                                    <img style="height: 70px" src="assets/images/footer-logo.jpg"></a>
                        ...
                        <div class="panel-body p-20">
                            ...
                            <form action="resultado.php" method="post" class="admin-login">
                                <div class="form-group">
                                    <label for="documento" class="control-label">Ingresa Número de Documento de Estudiante</label>
                                    <input type="text" class="form-control" id="documento" placeholder="Ingresa Número de Documento" autocomplete="off" name="documento">
                                </div>
                                <div class="form-group">
                                    <label for="default" class="control-label">Año</label>
                                    <select name="class" class="form-control" id="default" required="required">
                                        <option value="">Selecciona año Escolar del estudiante</option>
